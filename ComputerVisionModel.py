...
cap = cv2.VideoCapture("C:/Users/diaed/Downloads/Video.mp4")
...
async def send_to_websocket(detected_object):
    uri = "wss://newwebsocketserver.onrender.com"  # WebSocket server URI
    ...
    while cap.isOpened():
        ...
        for result in results:
            ...
            for i in range(detection_count):
                ...
                # Get the unique object ID for the detection
                try:
        ...
        # Write the processed frame to an output video (optional)
